...
const COMPANIES = [
...

  {
    ...
    blurb: "The largest streaming service globally by both revenue and subscribers, and the numbers now look like a company that's genuinely finished its growth-at-all-costs phase: operating margin has expanded from 17.82% to 29.49% since FY2022, free cash flow went from essentially breakeven to $9.46B, net debt/EBITDA has fallen to roughly 0.58x, and the entry multiple sits well below Netflix's own five-year average after a real ~43% pullback from its 2025 high (split-adjusted following a 10-for-1 forward split in Nov 2025). Clears EBIT growth, operating margin, FCF growth, market share, ROIC/WACC, net debt/EBITDA, entry multiple, share count trend, capex intensity and margin stability; misses revenue growth, market concentration, FCF conversion and insider/founder ownership (down to 0.58% company-wide as co-founder Reed Hastings has steadily sold down his stake).",
